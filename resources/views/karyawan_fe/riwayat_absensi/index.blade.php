        ...
        <div class="card border-0 shadow-sm bg-white" style="border-radius: 14px;">
            <div class="card-body p-3">
                <div class="d-flex justify-content-between align-items-center mb-3 pb-2 border-b border-gray-100">
                    ...
                    <span class="badge {{ $absen->status_masuk == 'hadir' ? 'bg-teal-50 text-teal-600' : ($absen->status_masuk == 'terlambat' ? 'bg-yellow-50 text-yellow-600' : 'bg-red-50 text-red-600') }} px-2 py-1 font-weight-bold" style="border-radius: 6px; font-size: 11px;">
                        {{ ucfirst($absen->status_masuk ?? 'Alpha') }}
                    </span>
                </div>
