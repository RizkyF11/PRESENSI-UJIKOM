                ...
                <nav id="left-sidebar-nav" class="sidebar-nav">
                    <ul id="main-menu" class="metismenu li_animation_delay">
                        ...
                        <li class="{{ request()->routeIs('karyawan.index') ? 'active' : '' }}">
                            <a href="{{ route('karyawan.index') }}"><i class="fa fa-users"></i><span>Karyawan</span></a>
                        </li>
                        {{-- <li class="{{ request()->routeIs('absensi.index') ? 'active' : '' }}">
                            <a href="{{ route('absensi.index') }}"><i class="fa fa-calendar-check-o"></i><span>Absensi</span></a>
                        </li>
                            --}}

                        {{-- <li class="{{ request()->routeIs('shift.index') ? 'active' : '' }}">
                            <a href="{{ route('shift.index') }}"><i class="fa fa-clock-o"></i><span>Shift</span></a>
                        </li>
                            --}}
                    </ul>
                </nav>
