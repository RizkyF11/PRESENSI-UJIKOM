            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                ...
                <ul class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="{{ route('admin.izin.index') }}"><i class="fa fa-dashboard"></i></a>
                    </li>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    {{-- APPROVE --}}
                                    @if($item->status == 'pending')
                                    <form action="{{ route('admin.izin.approve',$item->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                    ...
                                    {{-- REJECT --}}
                                    @if($item->status == 'pending')
                                    <form action="{{ route('admin.izin.reject',$item->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                    ...
                                    {{-- DELETE --}}
                                    <form action="{{ route('admin.izin.destroy',$item->id) }}"
                                        method="POST"
