    ...
    build: function () {
        return (
            (this.datatable = this.$table.DataTable({
                // Biarkan DataTables mendeteksi jumlah kolom secara otomatis
                autoWidth: false,
                responsive: true,
                // Kita matikan sorting hanya pada kolom terakhir secara dinamis
                columnDefs: [
                    { orderable: false, targets: -1 }, // -1 artinya kolom terakhir (Action)
                ],
            })),
